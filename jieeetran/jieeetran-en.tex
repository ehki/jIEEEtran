...
If jIEEEtran.bst has been installed by \TeX\ Live package manager, etc., and placed under PATH, write \bibliographystyle{jIEEEtran} in the preamble to complete the setup.
In the case that jIEEEtran.bst is individually downloaded and placed in the same directory as the main \TeX\ file for customization, etc., state \bibliographystyle{jIEEEtran} in the preamble in the same way to complete the setting.
