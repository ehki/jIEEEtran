...
If IEEJtran.bst has been installed by \TeX\ Live package manager, etc., and placed under PATH, write \bibliographystyle{IEEJtran} in the preamble to complete the setup.
In the case that IEEJtran.bst is individually downloaded and placed in the same directory as the main \TeX\ file for customization, etc., state \bibliographystyle{IEEJtran} in the preamble in the same way to complete the setting.
