...
@article{10009874585,
  author="奈良, 宏一 and 長谷川, 淳",
  title="新しい柔軟な電気エネルギー流通システム",
  ...
  number="1",
  pages="47-53",
  URL="https://ci.nii.ac.jp/naid/10009874585/",
  DOI="",
}
\end{filecontents}
...
日本人著者の取り扱いは、\texttt{author = \{\{}\textgt{姓姓 名名}\texttt{\} and \{}\textgt{姓姓 名名}\texttt{\}\}}と、\texttt{\{\}}で挟んでもいいですし、\texttt{author = \{姓姓 名名 and 姓姓 名名\}}と、\texttt{\{\}}で挟まなくても大丈夫です。
